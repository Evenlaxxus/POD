      ...
      <v-container>
        ...
        <v-row>
          ...
          <v-col>
            ...
            <v-row>
              <v-btn depressed large v-on:click="encode_playfair">Encode</v-btn>
            </v-row>
            <v-row>
              <v-textarea
                v-model="e"
            ...
            <v-row>
              <v-btn depressed large v-on:click="decode_playfair">Decode</v-btn>
            </v-row>
            <v-row>
              <v-textarea
                v-model="d"
          ...
          <v-col>
            ...
            <v-row>
              <v-col>
                <v-simple-table>
                  <tbody>
                    <tr height="10" v-for="(row, index) in matrix" :key="index">
